...
def lambda_handler(event, context):
    ...
    This function:
    1. Displays current time and weather for Houston, Texas
    2. Provides service selection options for Gen AI services
    3. Handles both GET (display UI) and POST (process selections) requests
    """
...
def get_weather_data():
    """
    Fetch weather data for Houston, Texas
...
def get_html_page():
    ...
    <head>
        ...
        <title>AWS Gen AI Dashboard - Houston</title>
        <style>
            * {{
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="container">
            ...
            <div class="header">
                ...
                <p style="color: #666;">Houston, Texas</p>
